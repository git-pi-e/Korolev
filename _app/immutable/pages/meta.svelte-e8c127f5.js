import{S as re,i as de,s as ue,e as o,t as n,k as y,c,a as r,h as s,d as i,m as k,b as h,g as he,J as e,n as V}from"../chunks/index-426c992b.js";const ve="Korolev",me="Plutoniumm",_e="SEDSCelestiaBPGC",be={current:6,previous:5,version:"3.3.2"},fe=1655494227790;var m={name:ve,author:me,owner:_e,build:be,time:fe};function pe(B){let l,t,_,S,D,b,W=m.name+"",I,N,f,X=m.author+"",O,F,p,Y=m.owner+"",H,G,v,M,Z=new Date(m.time).toLocaleString("en-GB",B[0])+"",P,R,T,$,E,ee=m.build.current+"",q,A,g,te=m.build.version+"",J,K,x,L,d,C,j,z;return{c(){l=o("main"),t=o("section"),_=o("h1"),S=n("Build Check"),D=y(),b=o("b"),I=n(W),N=n(" created by "),f=o("i"),O=n(X),F=n(` of
        `),p=o("i"),H=n(Y),G=n(`
        was last built
        `),v=o("code"),M=n(`\xA0
            `),P=n(Z),R=y(),T=o("br"),$=n(`
